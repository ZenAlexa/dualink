...
/// Clipboard format types for cross-platform clipboard sync
...
/// Clipboard events for lazy-pull clipboard sync
#[derive(Debug, Clone, serde::Serialize, serde::Deserialize)]
pub enum ClipboardEvent {
    /// Notify peers that clipboard content changed (available formats + total size hint)
    Changed {
